        ...
        <div className="container input-wrapper">
          <div className="space-adjust-1">
            <div className="row space-adjust">
              <div className="col">
                <input id="code1" type="number" className="keycode-input" value={this.props.keyCode1} onFocus={() => this.onFocus("code1")} onChange={this.handleChangeKeyCode1.bind(this)} maxLength={1} ref={this.textInputRef} name="code1" required/>
              </div>
              <div className="col">
                <input id="code2" type="number" className="keycode-input" value={this.props.keyCode2} onFocus={() => this.onFocus("code2")} onChange={this.handleChangeKeyCode2.bind(this)} maxLength={1} name="code2" required/>
              </div>
              <div className="col">
                <input id="code3" type="number" className="keycode-input" value={this.props.keyCode3} onFocus={() => this.onFocus("code3")} onChange={this.handleChangeKeyCode3.bind(this)} maxLength={1} name="code3" required/>
              </div>
              <div className="col">
                <input id="code4" type="number" className="keycode-input" value={this.props.keyCode4} onFocus={() => this.onFocus("code4")} onChange={this.handleChangeKeyCode4.bind(this)} maxLength={1} name="code4" required/>
              </div>
            </div>
          </div>
        </div>
