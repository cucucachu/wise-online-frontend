          ...
          <div className="row ">
            <div className="col-sm-6 course-card-info">
              <div className="course-card-info__content">
                ...
                <div>
                  <strong>{i18n("Class ID:")}</strong>{" "}
                  {this.props.course.classId}
                </div>
                {this.props.course.accessCode && (
                  <div>
                    <strong>{i18n("Access Code:")}</strong>{" "}
                    {this.props.course.accessCode}
                  </div>
                )}
                {integrationName && (
                  <p>
                    {`${integrationName} ID:`}{" "}
                    {this.props.course.integrationId
                      ? this.props.course.integrationId
                      : "Not Set"}
                  </p>
                )}
            ...
            <div className="col-sm-6">
              ...
              >
                <button
                  ...
                  style={{ marginBottom: "5px", fontSize: "medium" }}
                >
                  <img src={tickIcon} className="icon-xs" alt="tick icon" />
                  {i18n("Attendance")}
                </button>
              </Link>
              <Link
              ...
              >
                <button
                  ...
                  style={{ marginBottom: "5px", fontSize: "medium" }}
                >
                  <img src={editIcon} className="icon-xs" alt="edit icon" />
                  {i18n("Start Proctoring")}
                </button>
              </Link>
        ...
        <div className="shadow">
          <div className="row">
            ...
            <div className="col-sm-2">
              <button className="btn-neutral" onClick={this.handleClickCancel}>
          ...
          <div className="row">
            <div className="col-sm">
              <p>
                {i18n(
                  "Warning: Deleting a course perminantly deletes the course as well as all it's attendance and proctoring data."
                )}
              </p>
          ...
          <div className="row">
            <div className="col-sm-4">
              <button
                ...
                onClick={(e) => {
                  this.props.handleDelete(e, this.props.course._id);
                }}
              >
                {i18n("Delete")}
              </button>
